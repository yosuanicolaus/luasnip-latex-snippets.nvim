...
function M.retrieve(is_math)
  ...
  return {
    parse_snippet({ trig = "sum", name = "short sum" }, "\\sum"),
    parse_snippet({ trig = "bsum", name = "bottom sum" }, "\\sum_{${1:n=1}} $0"),
    parse_snippet({ trig = "dsum", name = "full sum" }, "\\sum_{${1:n=1}}^{${2:\\infty}} $0"),
